...
HELLO_VERSION = "/v1/kate6/version"
...
class Testkate6VersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_kate6_default_version(self, *args, **kwargs):
    ...
    def test_kate6_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
